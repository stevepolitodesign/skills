...
Two blank lines, always: one before the Act, one before the Assert. Assertions
running straight off the acting line make two phases out of three, and that's
the most common way this gets written wrong.
